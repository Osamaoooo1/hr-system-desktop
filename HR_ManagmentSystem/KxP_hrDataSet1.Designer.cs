...
namespace HR_ManagmentSystem {
    ...
    public partial class KxP_hrDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/KxP_hrDataSet1.xsd";
        ...
        public partial class AttendanceDataTable : global::System.Data.TypedTableBase<AttendanceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public AttendanceRow AddAttendanceRow(int attendanceID, employeesRow parentemployeesRowByFK_Attendance_employees, System.DateTime Date, string Status) {
...
namespace HR_ManagmentSystem.KxP_hrDataSetTableAdapters {
    ...
    public partial class AttendanceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Attendance] WHERE (([attendanceID] = @Original_attendanceID) AND ((@IsNull_employeeID = 1 AND [employeeID] IS NULL) OR ([employeeID] = @Original_employeeID)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Attendance] ([attendanceID], [employeeID], [Date], [Status]) V" +
                "ALUES (@attendanceID, @employeeID, @Date, @Status);\r\nSELECT attendanceID, employ" +
                "eeID, Date, Status FROM Attendance WHERE (attendanceID = @attendanceID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Attendance] SET [attendanceID] = @attendanceID, [employeeID] = @employeeID, [Date] = @Date, [Status] = @Status WHERE (([attendanceID] = @Original_attendanceID) AND ((@IsNull_employeeID = 1 AND [employeeID] IS NULL) OR ([employeeID] = @Original_employeeID)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)));
SELECT attendanceID, employeeID, Date, Status FROM Attendance WHERE (attendanceID = @attendanceID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT attendanceID, employeeID, Date, Status FROM dbo.Attendance";
        ...
        public virtual int Delete(int Original_attendanceID, global::System.Nullable<int> Original_employeeID, global::System.Nullable<global::System.DateTime> Original_Date, string Original_Status) {
        ...
        public virtual int Insert(int attendanceID, global::System.Nullable<int> employeeID, global::System.Nullable<global::System.DateTime> Date, string Status) {
        ...
        public virtual int Update(int attendanceID, global::System.Nullable<int> employeeID, global::System.Nullable<global::System.DateTime> Date, string Status, int Original_attendanceID, global::System.Nullable<int> Original_employeeID, global::System.Nullable<global::System.DateTime> Original_Date, string Original_Status) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> employeeID, global::System.Nullable<global::System.DateTime> Date, string Status, int Original_attendanceID, global::System.Nullable<int> Original_employeeID, global::System.Nullable<global::System.DateTime> Original_Date, string Original_Status) {
            return this.Update(Original_attendanceID, employeeID, Date, Status, Original_attendanceID, Original_employeeID, Original_Date, Original_Status);
        }
    }
